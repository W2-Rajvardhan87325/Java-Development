...
public class Program {
	...
	public static void main(String[] args) {
		...
		System.out.println("Created using (offerFirst|addFirst && pollFirst|removeFirst && peek|getFirst|peekFirst)");
		...
		System.out.println("Printing the top of the Stack ::" + stack.peekFirst());
		while (!stack.isEmpty()) {
			System.out.println(stack.pollFirst());
		}

		System.out.println("======================STACK ::2======================");
		System.out.println("Created using (offerLast|addLast && pollLast|removeLast && getLast|peekLast)");
		number = 0;
		System.out.println("Enter the Elements(Only 5)(Seprated by Spaces)::");
		for (int i = 1; i <= 5; i++) {
			System.out.print("Element ::" + i + "  Value ::");
